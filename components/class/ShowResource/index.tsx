  ...
  return (
    <div>
      <div className="absolute bg-indigo-200 w-full left-0 top-0 h-80 rounded-t-2xl tracking-normal  text-base leading-6 font-medium">
        ...
        {/* Teacher */}
        <div className="flex px-56 ml-0.5 m-3">
          <svg
            className="my-2"
            xmlns="http://www.w3.org/2000/svg"
            width="17"
          ...
          <div className="px-8 py-1">Tom Cook teacher</div>
        </div>
        {/* course */}
        <div className="flex px-56 pb-3">
          ...
          <div className="px-8 my-1">Ly Thuyet Thong ke</div>
        </div>
        {/* class */}
        <div className="flex px-56">
          ...
          <div className="px-9 my-3">LTTK 19TTH</div>
        ...
        <div className="ml-44 -mt-16">
          <textarea
            ...
            cols={67}
            value="Tom Cook nau canh chua ma khong ngon thi lam gi, no rat la do luon a.
          om Cook nau canh chua ma khong ngon thi lam gi, no rat la do luon a.
          om Cook nau canh chua ma khong ngon thi ấdlam gi, no luon aasdasdsdfsdf.Tom Cook nau canh chua ma khong ngon thi lam gi, no rat la do luon a. om Cook nau canh chua ma khong ngon thi lam gi, no rat la do luon a. om Cook nau canh chua ma khong ngon thi ấdlam gi, no luon a."
            rows={6}
          />
        </div>
        {/* Avatar */}
        <div className="float-right mr-8 -mt-48">
          <img
