...
function Infor_Minh_Nhut(props) {
  return (
    <div className=" px-16 flex items-center">
      <a
        href="https://www.facebook.com/phamvmnhut/"
        target="_blank"
        rel="noreferrer"
      >
      ...
      <a href="mailto:phamvmnhut@gmail.com?" target="_blank" rel="noreferrer">
        <div className="cursor-pointer">
          <svg
      ...
      <a
        ...
        href="https://github.com/phamvmnhut"
        target="_blank"
        data-hotkey="g d"
        aria-label="Homepage "
...
export default Infor_Minh_Nhut;
