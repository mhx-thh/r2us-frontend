...
function Infor_Cuu_Quan(props) {
  return (
    <div className=" px-16 flex items-center">
      <a
        href="https://www.facebook.com/profile.php?id=100030039214644"
        target="_blank"
        rel="noreferrer"
      >
      ...
      <a href="mailto:cuuquan2703@gmail.com?" target="_blank" rel="noreferrer">
        <div className="cursor-pointer">
          <svg
      ...
      <a
        ...
        href="https://github.com/cuuquan2703"
        target="_blank"
        data-hotkey="g d"
        aria-label="Homepage "
