...
function Infor_Tuyet_Anh(props) {
  return (
    <div className=" px-16 flex items-center">
      <a
        href="https://www.facebook.com/snowbri0207/"
        target="_blank"
        rel="noreferrer"
      >
      ...
      <a href="mailto:nttanh02@gmail.com?" target="_blank" rel="noreferrer">
        <div className="cursor-pointer">
          <svg
      ...
      <a
        ...
        href="https://www.github.com/tuyetanh0207"
        target="_blank"
        data-hotkey="g d"
        aria-label="Homepage "
...
export default Infor_Tuyet_Anh;
