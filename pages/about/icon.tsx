...
function IconContact(props) {
  return (
    <div className=" px-16 flex items-center">
      <Link href="https://www.facebook.com/hongtan1422002/">
        <div className="cursor-pointer">
          <svg
            className="h-7 w-5 text-black m-3"
            width="20"
            height="20"
            viewBox="0 0 24 24"
            fill="none"
      ...
      <Link href="https://www.facebook.com/hongtan1422002/">
        <div className="cursor-pointer">
          <svg
            className="h-6 w-6 text-black m-3 "
            width="24"
            height="24"
            viewBox="0 0 24 24"
            strokeWidth={2}
...
function IconContactMember1(props) {
  return (
    <div className=" px-6   flex items-center ">
      <Link href="https://www.facebook.com/hongtan1422002/">
        <div className="cursor-pointer">
          <svg
            className="h-5 w-5 text-black m-3"
            width="20"
            height="20"
            viewBox="0 0 24 24"
            fill="none"
